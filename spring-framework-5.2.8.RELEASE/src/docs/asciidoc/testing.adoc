...
.Java
----
	@ContextConfiguration(classes = test.TestConfig.class) // <1>
...
.Java
----
	@SpringJUnitConfig(test.TestConfig.class)
	@Sql("/test-schema.sql")
...
.Java
----
	@SpringJUnitConfig(test.TestConfig.class) // <1>
...
.Java
----
	@SpringJUnitWebConfig(test.TestConfig.class) // <1>
...
----
	...
	// "/test.TestConfig.groovy" in the root of the classpath
	@ContextConfiguration({"/AppConfig.groovy", "/test.TestConfig.Groovy"}) <1>
	class MyTest {
		// class body...
	}
----
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from
	// "/app-config.xml" and "/test.TestConfig.groovy"
	@ContextConfiguration({ "/app-config.xml", "/test.TestConfig.groovy" })
	class MyTest {
		// class body...
	}
----
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from AppConfig and test.TestConfig
	@ContextConfiguration(classes = {AppConfig.class, test.TestConfig.class}) // <1>
	class MyTest {
		// class body...
	}
----
...
----
	@ExtendWith(SpringExtension.class)
	// ApplicationContext will be loaded from test.TestConfig
	// and initialized by TestAppCtxInitializer
	@ContextConfiguration(
		classes = test.TestConfig.class,
...
.Java
----
	@ContextConfiguration(classes = test.TestConfig.class)
...
----
	...
	@ExtendWith(SpringExtension.class)
	// Instructs Spring to load an ApplicationContext from test.TestConfig.class
	@ContextConfiguration(classes = test.TestConfig.class)
	class SimpleTests {
...
----
	...
	// Jupiter and load an ApplicationContext from test.TestConfig.class
	@SpringJUnitConfig(test.TestConfig.class)
	class SimpleTests {
...
`ApplicationContext` loaded from `test.TestConfig.class` into the
...
loaded from `test.TestConfig.class` into the `deleteOrder()` test method:
